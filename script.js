...
const photoData = {
    'band-members': [
        'photos/band-members/BettyJo.webp',
        'photos/band-members/BettyJo2.webp',
        'photos/band-members/DrBob.webp',
        'photos/band-members/IMG_4136.PNG',
        'photos/band-members/IMG_4138.PNG',
        'photos/band-members/IMG_4142.PNG',
        'photos/band-members/Rachelle.webp',
        'photos/band-members/Scott.webp',
        'photos/band-members/image.JPG',
        'photos/band-members/image 2.JPG',
        'photos/band-members/image 3.JPG',
        'photos/band-members/image 4.JPG'
    ],
    'shows': [
        'photos/shows/BDD-Wesstside.webp'
    ],
    'behind-the-scenes': [
        'photos/behind-the-scenes/Classic.webp'
    ],
    'promo': [
        'photos/promo/BDDandD.jpeg',
        'photos/promo/646356971_26138163939174955_2616003753765380583_n.jpg'
    ],
    'history': [
        'photos/history/BDD.webp',
        'photos/history/BDD335.webp',
        'photos/history/BDD335BW.webp',
        'photos/history/BDDDOld.webp',
        'photos/history/BDDDOld2.webp',
        'photos/history/Old3352.webp',
        'photos/history/OldBass.webp',
        'photos/history/OldDrummer.webp',
        'photos/history/OldDrummer2.webp',
        'photos/history/OldDynamites.webp',
        'photos/history/OldKeyboard.webp',
        'photos/history/OldLive.webp',
        'photos/history/OldPromo.webp',
        'photos/history/OldPromo2.webp',
        'photos/history/OldRR.webp',
        'photos/history/rs=w-370,cg-true.webp'
    ],
    'other': [
        'photos/other/Pason.webp',
        'photos/other/Pason2.webp'
    ]
};
...
function loadPhotoGallery() {
    ...
    // Load all photos (hidden by default)
    Object.keys(photoData).forEach(category => {
        photoData[category].forEach((photoPath, index) => {
            const photoItem = document.createElement('div');
            photoItem.className = 'photo-item hidden'; // Hidden by default
